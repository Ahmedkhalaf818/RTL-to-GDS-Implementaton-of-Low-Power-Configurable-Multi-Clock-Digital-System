...
# Created by write_sdc on Thu Oct 9 06:03:51 2025
...
set_clock_groups -asynchronous -name UART_CLK1_1 -group [list [get_clocks UART_CLK1] [get_clocks TX_CLOCK] [get_clocks RX_CLOCK]] -group [list [get_clocks REF_CLK1] [get_clocks ALU_CLK]]
